#!/usr/bin/env python3
"""
Test 3: Lower FPS - 15fps with overlays to test timing issues
"""
...
pygame.display.set_caption("Test 3: Lower FPS")
...
print("=== Test 3: Lower FPS (15fps) ===")
print("Lower frame rate with overlays - watch for flickering")
...
try:
    ...
    while running and (time.time() - start_time) < 8 and video.active:
        ...
        # Add overlay to test if overlays cause flickering
        elapsed = time.time() - start_time
        remaining = max(0, 8 - int(elapsed))
        text = font.render(f"15fps - {remaining}s", True, WHITE)
        screen.blit(text, (20, 20))
        
        pygame.display.flip()
        clock.tick(15)  # LOWER FRAME RATE
